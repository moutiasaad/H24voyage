...
class ApiConfig {
  ...
  static const String AuthbaseUrl = 'https://api.boosterbc.com';
  // Laravel FCM backend (use 10.0.2.2 for Android emulator → host localhost)
  static const String fcmBaseUrl = 'http://10.0.2.2:8000/api';
  // API Credentials
  ...
  static const String registerCustomer = '/auth/b2c/register';
  static const String verifyRegisterOtp = '/auth/b2c/verify-register-otp';
  static const String login = '/auth/b2c/login';
  static const String verifyLoginOtp = '/auth/b2c/verify-login-otp';
