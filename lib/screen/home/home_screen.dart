...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  DropdownButton<String> getClass(BuildContext context) {
    final t = lang.S.of(context);

    List<DropdownMenuItem<String>> dropDownItems = [
      DropdownMenuItem(
        value: 'economy',
        child: Text(t.classEconomy),
      ),
      DropdownMenuItem(
        value: 'business',
        child: Text(t.classBusiness),
      ),
    ];
                      ...
                      child: Material(
                              ...
                              Column(
                                children: [
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: InputDecorator(
                                                ...
                                                child: ListTile(
                                                  ...
                                                  title: Text(
                                                    fromAirport != null ? '(${fromAirport!.code})' : '(DAC)',
                                                    style: kTextStyle.copyWith(
                                                      color: kTitleColor,
                                                      fontWeight: FontWeight.bold,
                                                    ),
                                  ...
                                  TextFormField(
                                    ...
                                    // ✅ Open date picker when tapping anywhere
                                    onTap: () {
                                      _showDepartureDate();
                                    },
                                  ...
                                  TextFormField(
                                    ...
                                    // ✅ Tap anywhere to open return date picker
                                    onTap: () {
                                      setState(() {
                                        isReturn = true;
                                      });
                        ...
                        TextFormField(
                          ...
                          decoration: kInputDecoration.copyWith(
                            ...
                            labelStyle: kTextStyle.copyWith(color: kTitleColor),
                            hintText:
                            '$adultCount Adult, $childCount child, $infantCount Infants',
                                  ...
                                  ButtonGlobalWithoutIcon(
                                    ...
                                    onPressed: () {
                                      if (fromAirport == null || toAirport == null) {
                                        toast('Please select both From and To airports');
                                        return;
                                      }
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: InputDecorator(
                                                      ...
                                                      child: ListTile(
                                                        ...
                                                        subtitle: Text(
                                                          fromAirport != null ? fromAirport!.city : 'Dhaka, Bangladesh',
                                                          style: kTextStyle.copyWith(color: kSubTitleColor),
                                                        ),
                                                        trailing: const Icon(IconlyLight.arrowDown2, color: kSubTitleColor),
                                                      ),
                                                    ),
                                                  ),
                                                ),
